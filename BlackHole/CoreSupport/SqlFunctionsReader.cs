            ...
            switch (NumericMethodData.MethodName)
            {
                    ...
                    if (NumericMethodData.MethodArguments.Count == 2)
                    {
                        if (NumericMethodData.CompareProperty != null && NumericMethodData.CastedOn != null)
                        {
                            ...
                            if (aTable != null && PropertyName != null && compareProperty.Length > 1)
                            {
                                ...
                                string SelectFromOtherTable = $"( Select {PropertyName} from {aTable} where Id = @{ParamName} )";
                                SqlCommand = $" {Letter}{compareProperty[1]} = {SelectFromOtherTable} ";
                                WasTranslated = true;
                            }
                        }
                    }
                ...
                case "SqlAverage":
                    if(NumericMethodData.CompareProperty != null && NumericMethodData.CastedOn != null)
                    {
                        ...
                        if(tableProperty.Length >1 && compareProperty.Length > 1)
                        {
                            ...
                            string SelectAverage = $"( Select AVG({tableProperty[1]}) from {NumericMethodData.TableName} )";
                            SqlCommand = $" {Letter}{compareProperty[1]} {operationType} {SelectAverage} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                    ...
                    if (NumericMethodData.CastedOn != null)
                    {
                        ...
                        if (NumericMethodData.ComparedValue != null)
                        {
                            if (compareProperty.Length > 1)
                            {
                                ...
                                SqlCommand = $" ABS({Letter}{compareProperty[1]}) {operationType} @{ParamName} ";
                                compareProp = true;
                                WasTranslated = true;
                            }
                        }
                        ...
                        if (!compareProp && NumericMethodData.CompareProperty != null)
                        {
                            ...
                            {
                                string operationType = ExpressionTypeToSql(NumericMethodData.OperatorType, !NumericMethodData.ReverseOperator, false);
                                SqlCommand = $" ABS({Letter}{compareProperty[1]}) {operationType} {Letter}{comparePropName[1]} ";
                                WasTranslated = true;
                            }
                        }
                    }
                    ...
                    if (NumericMethodData.CastedOn != null)
                    {
                        ...
                        if (NumericMethodData.ComparedValue != null)
                        {
                            if (compareProperty.Length > 1)
                            {
                                ...
                                ParamName = $"{compareProperty[1]}{Index}";
                                Value = NumericMethodData.ComparedValue;
                                SqlCommand = $" ROUND({Letter}{compareProperty[1]}{decimalPoints}) {operationType} @{ParamName} ";
                                compareProp = true;
                                WasTranslated = true;
                            }
                        }
                        ...
                        if (!compareProp && NumericMethodData.CompareProperty != null)
                        {
                            ...
                            {
                                string operationType = ExpressionTypeToSql(NumericMethodData.OperatorType, !NumericMethodData.ReverseOperator, false);
                                SqlCommand = $" ROUND({Letter}{compareProperty[1]}{decimalPoints}) {operationType} {Letter}{comparePropName[1]} ";
                                WasTranslated = true;
                            }
                        }
                    }
                ...
                case "SqlMax":
                    if (NumericMethodData.CastedOn != null)
                    {
                        ...
                        {
                            string SelectAverage = $"( Select MAX({tableProperty[1]}) from {NumericMethodData.TableName} )";
                            SqlCommand = $" {Letter}{tableProperty[1]} = {SelectAverage} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                case "SqlMin":
                    if (NumericMethodData.CastedOn != null)
                    {
                        ...
                        if (tableProperty.Length > 1)
                        {
                            string SelectAverage = $"( Select MIN({tableProperty[1]}) from {NumericMethodData.TableName} )";
                            SqlCommand = $" {Letter}{tableProperty[1]} = {SelectAverage} ";
                            WasTranslated = true;
                        }
                    }
                        ...
                        if (compareProperty.Length > 1)
                        {
                            if (NumericMethodData.ComparedValue != null)
                            {
                                ...
                                if (thePlusValue != null)
                                {
                                    ParamName = $"{compareProperty[1]}{Index}";
                                    Value = NumericMethodData.ComparedValue;
                                    SqlCommand = $" ({Letter}{compareProperty[1]} + {Letter}{thePlusValue.Name}) {operationType} @{ParamName} ";
                                    WasTranslated = true;
                                }
                                else
                                {
                                    ParamName = $"{compareProperty[1]}{Index}";
                                    Value = NumericMethodData.ComparedValue;
                                    SqlCommand = $" ({Letter}{compareProperty[1]} + {NumericMethodData.MethodArguments[1]}) {operationType} @{ParamName} ";
                                    WasTranslated = true;
                                }
                            }
                            ...
                            if (!hasCompareValue && NumericMethodData.CompareProperty != null)
                            {
                                ...
                                if(otherPropName.Length > 1)
                                {
                                    if (thePlusValue != null)
                                    {
                                        SqlCommand = $" ({Letter}{compareProperty[1]} + {Letter}{thePlusValue.Name}) {operationType} {Letter}{otherPropName[1]} ";
                                    }
                                    else
                                    {
                                        SqlCommand = $" ({Letter}{compareProperty[1]} + {NumericMethodData.MethodArguments[1]}) {operationType} {Letter}{otherPropName[1]} ";
                                    }
                ...
                case "Contains":
                    if (StringMethodData.MethodArguments.Count == 1 && StringMethodData.CastedOn != null)
                    {
                        ...
                        if (tableProperty.Length > 1)
                        {
                            ...
                            SqlCommand = $" {Letter}{tableProperty[1]} Like @{ParamName}";
                            WasTranslated = true;
                        }
                    }
                    break;
                ...
                case "ToUpper":
                    if (StringMethodData.ComparedValue != null && StringMethodData.CastedOn != null)
                    {
                        ...
                        if (compareProperty.Length > 1)
                        {
                            ...
                            SqlCommand = $" UPPER({Letter}{compareProperty[1]}) {operationType} @{ParamName} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                case "ToLower":
                    if(StringMethodData.ComparedValue != null && StringMethodData.CastedOn != null)
                    {
                        ...
                        if(compareProperty.Length > 1)
                        {
                            ...
                            ParamName = $"{compareProperty[1]}{Index}";
                            Value = StringMethodData.ComparedValue;
                            SqlCommand = $" LOWER({Letter}{compareProperty[1]}) {operationType} @{ParamName} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                case "Replace":
                    if(StringMethodData.CastedOn != null && StringMethodData.MethodArguments.Count == 2 && StringMethodData.ComparedValue != null)
                    {
                        ...
                        if (compareProperty.Length > 1)
                        {
                            ...
                            ParamName = $"{compareProperty[1]}{Index}";
                            Value = StringMethodData.ComparedValue;
                            SqlCommand = $" REPLACE({Letter}{compareProperty[1]},'{first}','{second}') {operationType} @{ParamName} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                case "SqlLength":
                    if (StringMethodData.ComparedValue != null && StringMethodData.CastedOn != null)
                    {
                        ...
                        if (compareProperty.Length > 1)
                        {
                            ...
                            ParamName = $"{compareProperty[1]}{Index}";
                            Value = StringMethodData.ComparedValue;
                            SqlCommand = $" LENGTH({Letter}{compareProperty[1]}) {operationType} @{ParamName} ";
                            WasTranslated = true;
                        }
                    }
                    break;
            ...
            switch (DateMethodData.MethodName)
            {
                ...
                case "SqlDateAfter":
                    if (DateMethodData.MethodArguments.Count == 2 && DateMethodData.CastedOn != null)
                    {
                        ...
                        if(compareProperty.Length > 1)
                        {
                            ...
                            Value = DateMethodData.MethodArguments[1];
                            SqlCommand = $" {Letter}{compareProperty[1]} >= @{ParamName} ";
                            WasTranslated = true;
                        }
                    }
                    break;
                ...
                case "SqlMax":
                    if (DateMethodData.CastedOn != null)
                    {
                        ...
                        if (tableProperty.Length > 1)
                        {
                            string SelectAverage = $"( Select MAX({tableProperty[1]}) from {DateMethodData.TableName} )";
                            SqlCommand = $" {Letter}{tableProperty[1]} = {SelectAverage} ";
                            WasTranslated = true;
                        }
                    }
                ...
                case "SqlMin":
                    if (DateMethodData.CastedOn != null)
                    {
                        ...
                        if (tableProperty.Length > 1)
                        {
                            string SelectAverage = $"( Select MIN({tableProperty[1]}) from {DateMethodData.TableName} )";
                            SqlCommand = $" {Letter}{tableProperty[1]} = {SelectAverage} ";
                            WasTranslated = true;
                        }
                    }
