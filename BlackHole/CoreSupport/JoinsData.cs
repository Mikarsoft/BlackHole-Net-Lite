...
namespace BlackHole.CoreSupport
{
    ...
    public class JoinsData<TSource,TOther>
    {
        ...
        internal List<TableLetters> TablesToLetters { get; set; }
        internal List<TableProperties> AllProps { get; set; }
        internal List<string> Letters { get; set; }
    ...
    public class PreJoinsData<TSource, TOther>
    {
        ...
        internal List<string> Letters { get; set; }
        internal string Joins { get; set; } = string.Empty;
        internal string WherePredicates { get; set; }
        internal List<BlackHoleParameter> DynamicParams { get; set; }
        internal int HelperIndex { get; set; }
        internal bool Ignore { get; set; }
        internal int ParamsCount { get; set; }
