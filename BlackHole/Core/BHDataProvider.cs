...
namespace BlackHole.Core
{
    ...
    public static class BHDataProvider
    {
        ...
        /// </summary>
        public static BHConnection Command;
        ...
        internal static BHEntityContext<T> MapEntity<T>(this BHEntityContext context) where T : BlackHoleEntity
        {
            return new(context.WithActivator, context.ThisTable, context.Columns, context.PropertyNames, context.PropertyParams, context.UpdateParams);
        }
