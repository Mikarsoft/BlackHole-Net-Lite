...
namespace BlackHole.Core
{
    ...
    public static class ExecutionMethods
    {
        ...
        public static List<T> GetAllEntries<T>(this BHEntityContext<T> context) where T : BlackHoleEntity
        {
            ...
            {
                return _dataProvider.Query<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Inactive = 0", null);
            }
            return _dataProvider.Query<T>($"select Id,{context.PropertyNames} from {context.ThisTable}", null);
        }
        ...
        public static List<T> GetAllInactiveEntries<T>(this BHEntityContext<T> context) where T : BlackHoleEntity
        {
            if (context.WithActivator)
            {
                return _dataProvider.Query<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Inactive = 1", null);
            }
            return new List<T>();
        }
        ...
        public static T GetEntryById<T>(this BHEntityContext<T> context,int Id) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.QueryFirst<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Id = @Id and Inactive = 0", Params.Parameters);
            }
            return _dataProvider.QueryFirst<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Id = @Id", Params.Parameters);
        }
        ...
        public static T GetEntryWhere<T>(this BHEntityContext<T> context, Expression<Func<T, bool>> predicate) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.QueryFirst<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Inactive = 0 and {sql.Columns}", sql.Parameters);
            }
            return _dataProvider.QueryFirst<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where {sql.Columns}", sql.Parameters);
        }
        ...
        public static List<T> GetEntriesWhere<T>(this BHEntityContext<T> context, Expression<Func<T, bool>> predicate) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.Query<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where Inactive = 0 and {sql.Columns}", sql.Parameters);
            }
            return _dataProvider.Query<T>($"select Id,{context.PropertyNames} from {context.ThisTable} where {sql.Columns}", sql.Parameters);
        }
        ...
        {
            return _dataProvider.InsertScalar($"insert into {context.ThisTable} ({context.PropertyNames},Inactive", $"values ({context.PropertyParams}, 0", entry);
        }
        ...
        {
            return _dataProvider.ExecuteEntry($"update {context.ThisTable} set {context.UpdateParams} where Id = @Id", entry);
        }
        ...
        public static bool UpdateEntriesWhere<T>(this BHEntityContext<T> context, Expression<Func<T, bool>> predicate, T entry) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.JustExecute($"update {context.ThisTable} set {context.UpdateParams} where Inactive = 0 and {sql.Columns}", sql.Parameters);
            }
            return _dataProvider.JustExecute($"update {context.ThisTable} set {context.UpdateParams} where {sql.Columns}", sql.Parameters);
        }
        ...
        public static bool DeleteAllEntries<T>(this BHEntityContext<T> context) where T : BlackHoleEntity
        {
            if (context.WithActivator)
            {
                return _dataProvider.JustExecute($"update {context.ThisTable} set Inactive = 1 where Inactive = 0", null);
            }
            return _dataProvider.JustExecute($"delete from {context.ThisTable}", null);
        }
        ...
        public static bool DeleteEntryById<T>(this BHEntityContext<T> context, int Id) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.JustExecute($"Update {context.ThisTable} set Inactive = 1 where Id = @Id", Params.Parameters);
            }
            return _dataProvider.JustExecute($"delete from {context.ThisTable} where Id = @Id", Params.Parameters);
        }
        ...
        public static bool DeleteInactiveEntryById<T>(this BHEntityContext<T> context, int Id) where T : BlackHoleEntity
        {
            BHParameters Params = new();
            Params.Add("Id", Id);
            return _dataProvider.JustExecute($"delete from {context.ThisTable} where Id= @Id and Inactive = 1", Params.Parameters);
        }
        ...
        public static bool ReactivateEntryById<T>(this BHEntityContext<T> context, int Id) where T : BlackHoleEntity
        {
            BHParameters Params = new();
            Params.Add("Id", Id);
            return _dataProvider.JustExecute($"update {context.ThisTable} set Inactive = 0 where Id = @Id and Inactive = 1", Params.Parameters);
        }
        ...
        public static bool DeleteEntriesWhere<T>(this BHEntityContext<T> context, Expression<Func<T, bool>> predicate) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.JustExecute($"update {context.ThisTable} set Inactive = 1 where {sql.Columns}", sql.Parameters);
            }
            return _dataProvider.JustExecute($"delete from {context.ThisTable} where {sql.Columns}", sql.Parameters);
        }
        ...
        public static List<int> GetIdsWhere<T>(this BHEntityContext<T> context, Expression<Func<T, bool>> predicate) where T : BlackHoleEntity
        {
            ...
            if (context.WithActivator)
            {
                return _dataProvider.Query<int>($"select Id from {context.ThisTable} where Inactive = 0 and {sql.Columns}", sql.Parameters);
            }
            return _dataProvider.Query<int>($"select Id from {context.ThisTable} where {sql.Columns}", sql.Parameters);
        }
        ...
        public static List<Dto> ExecuteQuery<Dto>(this JoinsData data) where Dto : BlackHoleDto
        {
            ...
            return _dataProvider.Query<Dto>(commandText, data.DynamicParams);
        }
        ...
        {
            return _dataProvider.Query<Dto>(storedV.CommandText,storedV.DynamicParams);
        }
